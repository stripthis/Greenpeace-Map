...
<div id="app-header">
  ...
  <div id="main-nav-holder">
    <div class="main nav">
      <ul class="level1">
        <li><a href="index.php?page=risk<?php echo $password;?>"<?php if($page=='risk'): ?> class="active"<?php endif; ?>><span>Resiko</span></a></li>
        <li><a href="index.php?page=app<?php echo $password;?>"<?php if($page=='app'): ?> class="active"<?php endif; ?>><span>SMG/APP</span></a></li>
        <li><a href="index.php?page=toy<?php echo $password;?>"<?php if($page=='toy'): ?> class="active"<?php endif; ?>><span>Mainan</span></a></li>
        <li><a href="index.php?page=solutions<?php echo $password;?>"<?php if($page=='solutions'): ?> class="active"<?php endif; ?>><span>Solusi</span></a></li>
      </ul>
<?php switch($page) : ?>
<?php case('app'): ?>
      <ul class="level2 js_places page-nav">
        <li class=""><a href="#overview" data-itemid="home" class="js_place first" id="overview"><span class="long">Sekilas Sumatra</span></a></li>
...
<?php case('toy'): ?>
      <ul class="level2 page-nav">
        <li><a href="#intro" class="first" id="intro"><span class="long">Sekilas sektor mainan</span></a></li>
        <li><a href="#mattel" id="mattel"><span>Mattel</span></a></li>
        <li><a href="#disney" id="disney"><span>Disney</span></a></li>
        <li><a href="#others" id="others"><span>Lainnya</span></a></li>
      </ul>
<?php break; ?>
<?php case('solutions'): ?>
      <ul class="level2 page-nav">
        <li><a href="#lowcarbon" class="first" id="lowcarbon"><span class="long">Rendah karbon</span></a></li>
      </ul>
<?php break; ?>
<?php case('risk'): ?>
      <ul class="level2 page-nav">
        <li><a href="#plannedloss" class="first" id="plannedloss"><span class="long">Kerugian terencana</span></a></li>
      </ul>
<?php break; ?>
<?php endswitch; ?>
    </div>
